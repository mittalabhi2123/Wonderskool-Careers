...
public class ExcelWriterTest
{
  ...
  public static void write(File file, String firstColHeading)
    throws Exception
  {
  ...
  private static void createLabel(WritableSheet sheet, HashMap<String, List<String>> traitProfData, String firstColHeading)
    throws WriteException
  {
    ...
    WritableFont times10ptBoldUnderline = new WritableFont(WritableFont.TIMES, 12, WritableFont.NO_BOLD, false, UnderlineStyle.SINGLE);
