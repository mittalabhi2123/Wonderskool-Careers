...
public class ProcessBulkResults extends JFrame {
	LinkedHashMap<String, String> stuDataLst = new LinkedHashMap<String, String>();
	...
	private void initComponents() {
		...
		this.classCombo.setModel(new DefaultComboBoxModel(new String[] { "All", "PRE-NUR", "NUR", "KG", "L-KG", "U-KG",
				"I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII" }));

		this.sectionCombo.setModel(new DefaultComboBoxModel(new String[] { "All", "A", "B", "C", "D", "E", "F", "G",
						...
						layout.createSequentialGroup()
								...
								.addGroup(
										layout.createParallelGroup(GroupLayout.Alignment.LEADING)
														...
														layout.createSequentialGroup()
																.addGroup(
																		layout.createParallelGroup(
																				...
																				.addComponent(this.errMsgLbl, -1, -1,
																						32767)
																				.addGroup(
																						layout.createSequentialGroup()
																								.addGroup(
												...
												.addGroup(
														layout.createSequentialGroup()
																.addComponent(this.progressBarLbl, -2, 313, -2)
												...
												layout.createSequentialGroup()
														.addGroup(
																layout.createParallelGroup(
																		...
																		.addComponent(this.classCombo, -2, -1, -2)
																		.addComponent(this.batchLbl))
														.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
														.addGroup(
																layout.createParallelGroup(
																		GroupLayout.Alignment.BASELINE)
																		.addComponent(this.sectionCombo, -2, -1, -2)
														...
														.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(this.prgressBar, -2, 25, -2))
										.addComponent(this.jScrollPane1, GroupLayout.Alignment.TRAILING, -2, -1, -2))
						.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.progressBarLbl)
						.addContainerGap(-1, 32767)));
	...
	private void saveBtnActionPerformed(ActionEvent evt) {
		...
		try {
			...
			Vector<String> noResultEnroll = new Vector<String>();
			for (String enrollNoTemp : this.stuDataLst.keySet()) {
				...
				new Thread() {
					public void run() {
						...
						ProcessBulkResults.this.prgressBar.setString("Processing:"
								+ (ProcessBulkResults.this.stuDataLst.size() - ProcessBulkResults.this.runningCounter)
								+ "/" + ProcessBulkResults.this.stuDataLst.size() + "-"
								+ (String) ProcessBulkResults.this.stuDataLst.get(ProcessBulkResults.this.enrollNo)
								+ "(" + ProcessBulkResults.this.enrollNo + ")");
				...
				ResultSet dataSet = Utility.conn.createStatement().executeQuery(
						QueryCollection.STUDENT_RESULT.GET_EXISTING_DATA.replace("?", this.enrollNo.toLowerCase()));
				while (dataSet.next()) {
					marksMap.put(dataSet.getString(4), dataSet.getDouble(5));
				}
				if (marksMap.isEmpty()) {
					noResultEnroll.add(enrollNoTemp);
				} else
					ProcessSingleResult.processMarksData(this.instName, this.enrollNo, marksMap, cutOffMap,
							criteria2ProfMap, prof2CriteriaMap);
			}
	...
	private void getStudentLst(JLabel errMsgLbl) throws Exception {
